...
---
# About IOPA
> Background behind the Organization and the Specification
...
## Internet Open Protocols Alliance
The Internet Open Protocols Alliance (also abbreviated IOPA) is the not-for-profit organizing body that maintains and publishes the *Internet Open Protocols Abstraction* specification.  See [Free and Open Source](doc:free-and-open-source) for more details.
